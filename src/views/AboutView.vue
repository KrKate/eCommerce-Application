<template>
  <main>
    ...
    <div class="bio" v-if="isShowKirillBio">
      <div class="bio__text">
        <img src="@/assets/icons/close.png" @click="showKirillBio(false)" alt="close" />
        <h3>Short biography</h3>
        <p>
          Kirill solves complex problems while creating some of the most advanced applications in
          the industry. Communicates with other front-end developers within the company on best
          practices, new technologies. Excellent knowledge of JavaScript/TypeScript, HTML and CSS.
          Provides mentorship and supervise developers. Ensures the solution is scalable and meets
          overall business requirements. Guides technical teams to deliver flexible and scalable
          solutions.
        </p>
        ...
        <ul>
          ...
          <li>Product Filtering, Sorting, and Searching</li>
          <li>
            Registration Page - Integration with commercetools for User Profiles and Addresses
          </li>
          <li>Registration Page - State Management, Automatic Login, and Redirection</li>
          <li>Login Page - Redirection</li>
          <li>Login Page - Integration with Authentication Service</li>
    ...
    <div class="bio" v-if="isShowTeamBio">
      <div class="bio__text">
        <img src="@/assets/icons/close.png" @click="showTeamBio(false)" alt="close" />
        <h3>Collaboration</h3>
        <p>
          The online store project was launched in August 2023 as part of the final project in the
          JavaScript/Front-end 2023Q1 course, with the goal of providing users with a convenient and
          modern way to buy Pokemon online. The project team consisted of three people: a team lead
          and two frontend developers. In the process of writing the project, two people remained in
          the team: the team lead and the frontend developer. Each of them had their own
          responsibilities, but also worked closely with other team members. To collaborate
          effectively, the team used various tools and methodologies, such as:
        </p>
        <ul>
          <li>
            <b>GitHub Project</b> - A project is an adaptable spreadsheet, task-board, and road map
            that integrates with your issues and pull requests on GitHub to help you plan and track
            your work effectively. You can create and customize multiple views by filtering,
            sorting, grouping your issues and pull requests, visualize work with configurable
            charts, and add custom fields to track metadata specific to your team. Rather than
            enforcing a specific methodology, a project provides flexible features you can customize
            to your team’s needs and processes.
          </li>
          <li>
            <b>GitHub</b> - is a code storage and management platform that allows a team to work on
            the same project, making changes in different branches and merging them into the master
            branch after review.
          </li>
          <li>
            <b>Jest</b> - is a framework for testing JavaScript code that helps the tester check the
            functionality and quality of the code, as well as find and fix errors.
          </li>
          <li>
            <b>Vue 3</b> - Vue (pronounced /vjuː/, like view) is a JavaScript framework for building
            user interfaces. It builds on top of standard HTML, CSS, and JavaScript and provides a
        ...
        <p>
          Thanks to these tools and methodologies, the team was able to successfully complete the
          online store project in just over a month. The online store turned out to be functional,
          attractive and user-friendly. We hope that users will be satisfied with the result and
          leave positive feedback about the team’s work.
        </p>
      </div>
    </div>
    <div class="bio" v-if="isShowKateBio">
      <div class="bio__text">
        <img src="@/assets/icons/close.png" @click="showKateBio(false)" alt="close" />
        <h3>Short biography</h3>
        <p>
          Ekaterina solves complex problems while creating some of the most advanced applications in
          the industry. Communicates with other front-end developers within the company on best
          practices, new technologies. Excellent knowledge of JavaScript/TypeScript, HTML and CSS.
          Provides mentorship and supervise developers. Ensures the solution is scalable and meets
          overall business requirements. Guides technical teams to deliver flexible and scalable
        ...
        <h3>Contribution to the project</h3>
        <ul>
          <li>Display Product List</li>
          <li>Interactive Product Cards</li>
          <li>Enlarged Image Modal with Slider</li>
    ...
    <div id="img-container">
      ...
      <img src="@/assets/images/r-team.png" alt="r-team" />
      <a href="https://rs.school/" target="_blank"
        ><img id="rs-logo" src="https://rs.school/images/rs_school.svg" alt="r-team"
      /></a>
    </div>
    <div class="kir-info">
      <div ref="kir" class="card">
        <div class="shadow"></div>
        <div class="image background"></div>
        <div class="image cutout"></div>
        <div class="content">
          <h3>Kirill Demyanenko</h3>
          <img id="photo" src="@/assets/images/e.webp" alt="kate" />
          <h4>Developer</h4>
          <p>
            Creative, intelligent and goal-oriented person who loves to solve complex problems using
            computer technology
          </p>
          <div class="links">
            <a href="https://github.com/KirillDemyanenko" target="_blank"
              ><img src="@/assets/icons/GitHub_Logo.png" alt="GitHub"
            /></a>
            <img src="@/assets/icons/resume.png" alt="resume" @click="showKirillBio(true)" />
          </div>
        </div>
      </div>
    </div>
  ...
  .kir-info {
    ...
    .card {
      ...
      &:hover {
        ...
        .image {
          transform: translate3d(0%, 30%, 400px);
          scale: 0.9 0.9;
        }
      }
      ...
      .image {
        ...
        transition: 1s;
        inset: 0;
        background: linear-gradient(to top, rgba(248, 244, 244, 0.5), transparent 40%), var(--url);
        background-size: cover;
        background-position: center;
        ...
        &.cutout {
          transform: rotateX(var(--rotateX)) rotateY(var(--rotateY)) translate3d(0, 0, 4rem)
            scale(0.92);
          z-index: 3;
        }
      }
...
export default {
  data() {
    return {
      isShowKirillBio: false,
      isShowKateBio: false,
      isShowTeamBio: false
    }
  },
  methods: {
    showKateBio(state: boolean): void {
      this.isShowKateBio = state
    },
    showKirillBio(state: boolean): void {
      this.isShowKirillBio = state
    },
    showTeamBio(state: boolean): void {
      this.isShowTeamBio = state
    }
  }
}
</script>
